...
from .preview_mode import preview_is_on, preview_mesh_quality, preview_wireframe
...
class SphereBuilderPage(PointTableBuilderPage):
    ...
    def _refresh_preview(self):
        ...
        try:
            ...
            quality = preview_mesh_quality(self._wireframe_quality_level(), mode)
    ...
    def _add_preview_points(self, new_pts):
        ...
        added = self._preview.add_points(
            ...
            self._radius_widget.value(),
            wire,
            preview_mesh_quality(self._wireframe_quality_level(), mode),
        )
